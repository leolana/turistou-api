...
import {
  entityToPaymentTransactionSerializer,
  modelToPaymentTransactionEntity,
  paymentConditionInputToPaymentTransactionModel,
...
export const inputToPassengerModel = (input: SavePassengerInput): IPassenger =>
  <Passenger>{
